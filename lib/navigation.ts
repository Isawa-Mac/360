...
export const navItems: NavItem[] = [
  ...
  },
  {
    ...
    url: (() => {
      const u = process.env.NEXT_PUBLIC_CHATBOT360_URL || process.env.NEXT_PUBLIC_CHATBOT_URL || "https://chatbot360.trirex.cloud/";
      return /^https?:\/\//.test(u) ? u : "https://chatbot360.trirex.cloud/";
    })(),
    icon: MessageCircle,
