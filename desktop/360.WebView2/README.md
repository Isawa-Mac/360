...
ตัวติดตั้งจะอยู่ที่ `desktop/installer/output/360-Setup-1.0.15-win-x64.exe` และติดตั้งแบบ per-user ที่ `%LOCALAPPDATA%\Programs\TRIREX\360` โดยสร้าง shortcut ใน Start Menu และ Desktop
